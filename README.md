...
to **11 bit-level-verified events** across two boards. One cleared **seven** bits
...
live. Observed range so far: bits 26–40 cleared, 1–7 per event, magnitudes 8.9 min–21.5 h, always expressible as
